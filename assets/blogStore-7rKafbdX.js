import{A as f}from"./index-BywiyRfk.js";const y="/assets/post-1-thumbnail-CJ1ArFnX.webp",e="/assets/avatar-hoodie-BzOxiO2N.webp",w="/assets/post-1-cover-DPBNQ-cM.webp",v={id:1,title:"What UX Means to Me",slug:"what-ux-means-to-me",date:"2025-08-05",summary:'UX didn’t just become the career I had always been after. It became a mirror of how I live, think, and grow. But what does that really mean? Read about how I realized UX was always part of my life long before I had ever heard the term "UX".',content:`
  ...
  `,tags:["personal","career","ux-philosophy"],category:"Reflection",author:{name:"Juan Lagunas",avatar:e,bio:"UX Designer, Developer, and Dreamer",website:"https://yourportfolio.com",twitter:"https://twitter.com/yourhandle"},coverImage:w,thumbnail:y,imageAlt:"Abstract visual representing UX journey",readingTime:"6 min read",published:!0,updated:"2025-08-05",relatedPosts:["why-i-chose-vue","ux-vs-ui"],showToc:!1,problem:"I felt disconnected from my work and wanted to find a field that aligned with my natural way of thinking and growing.",solution:"UX gave me a framework that mirrored how I already approach challenges in life. Empathetically, iteratively, and with intention.",outcome:"I’ve found a career path that excites me, challenges me, and gives me space to evolve. And I’m all in."},k="/assets/bean-beast-thumbnail-BCKQOMfX.webp",I="/assets/bean-beast-cover-CS2MHa3H.webp",x={id:2,title:"What I Learned From Following the Full UX Process",slug:"what-i-learned-full-ux-process",date:"2025-08-06",summary:"Bean & Beast was the first time I followed the full design thinking framework from start to finish and because of that, it changed everything. From user research to wireframes to final code, here’s what I learned and why it made me feel like a real designer for the first time.",content:`
  ...
  `,tags:["ux-frameworks","design-thinking","ux-process"],category:"UX Design",author:{name:"Juan Lagunas",avatar:e,bio:"UX Designer, Developer, and Dreamer",website:"https://yourportfolio.com",twitter:"https://twitter.com/yourhandle"},coverImage:a,thumbnail:a,imageAlt:"Custom UX framework flowchart diagram",readingTime:"4 min read",published:!0,updated:"2025-08-12",relatedPosts:["top-ux-design-frameworks","design-thinking-guide"],showToc:!1,problem:"I wanted a single, easy-to-read visual that showed the full UX process from start to finish, including iteration points and possible outputs at each stage.",solution:"I designed my own flowchart, modeled after the Google UX Designer Course framework, to visualize the process and list associated artifacts.",outcome:"A reusable reference diagram that helps me and others keep track of the UX process and deliverables for any project."},s="/assets/ux-features-CzjIcVjt.webp",j="/assets/post-5-img-1-DMHDA0on.webp",B="/assets/post-5-img-2-CTdsrwGt.webp",A="/assets/post-5-img-3-6hDYESmH.webp",C="/assets/name_logo-rIdEqb-S.webp",z={id:5,title:"UX Features Built Into My Portfolio",slug:"ux-features-in-my-portfolio",date:"2025-08-18",summary:"My portfolio isn’t just a place to show my work, I thought about it as a UX project in itself. From navigation and layout to case study storytelling, I intentionally designed features that make the experience smooth, accessible, and even fun. Here’s a breakdown of the UX features I built into my portfolio and why they matter.",content:`
   ...
   <p><strong>Why it’s good UX:</strong> These navigation choices align with multiple usability heuristics. The persistent navbar and sidebar give users <em>visibility of system status</em> and <em>user control</em>, so they always know where they are and how to move. Icons paired with text improve <em>recognition rather than recall</em>, since users don’t have to guess what each option means. The sticky navbar and back-to-top button increase <em>efficiency of use</em>, reducing scrolling effort in long case studies. Even the loading spinner with captions addresses <em>visibility of system status</em> by giving clear feedback that the system is working while adding a touch of personality to keep the experience engaging.</p>
    ...
    <img src=${j} alt="Navigation and access UX features screenshot" class="my-6 rounded-lg shadow-lg" />
    ...
    <img src=${B} alt="Hero section and layout UX features screenshot" class="my-6 rounded-lg shadow-lg" />
...
<p><strong>Why it’s good UX:</strong> My case studies are designed with heuristics like <em>consistency and standards</em> and <em>recognition rather than recall</em> in mind. Downloadable PDFs and links to live sites provide <em>flexibility</em> so users can choose their preferred format. UX tags at the top give <em>visibility</em> into what the study covers. Auto-scrolling visual artifacts paired with short blurbs help chunk information into <em>recognizable</em>, digestible units rather than relying on users to recall details. Tabbed solution sections demonstrate <em>aesthetic and minimalist design</em> by avoiding overwhelming walls of content. Finally, the sticky navbar and back button reinforce <em>user control and freedom</em>, allowing readers to navigate or exit easily at any point.</p>
    ...
    <img src=${A} alt="Case study UX features screenshot" class="my-6 rounded-lg shadow-lg" />
   ...
   <p><strong>Why it’s good UX:</strong> My custom logo supports <em>consistency and standards</em> by giving a recognizable visual anchor across my portfolio. It also contributes to <em>aesthetic and minimalist design</em>, keeping branding clean and professional without excess. Strong branding builds trust and credibility, aligning with the heuristic of <em>match between system and real world</em>: just as products use branding to signal reliability, a designer’s portfolio benefits from recognizable identity that sets expectations and reassures users they’re in the right place.</p>
    ...
    <img src=${C} alt="Custom logo branding screenshot" class="my-6 rounded-lg shadow-lg h-56" />
  ...
  `,tags:["ux","portfolio","ux-features"],category:"UX Design",author:{name:"Juan Lagunas",avatar:e,bio:"UX Designer, Developer, and Dreamer",website:"https://yourportfolio.com",twitter:"https://twitter.com/yourhandle"},coverImage:s,thumbnail:s,imageAlt:"Screenshots of UX features in portfolio",readingTime:"7 min read",published:!0,updated:"2025-08-18",relatedPosts:["my-custom-ux-framework-flowchart","top-ux-design-frameworks"],showToc:!1,problem:"Portfolios are often designed only as showcases, but recruiters and hiring managers experience them as products they need to navigate.",solution:"I treated my portfolio as a UX project in itself, adding thoughtful features to make it more usable, engaging, and accessible.",outcome:"A portfolio that not only shows my work but also proves my UX thinking in action."},o="/assets/portfolio-iteration-cover-BsrkbYNA.webp",P="/assets/hero-before-after-DmhJzkU-.webp",$="/assets/work-section-BxTx4vOq.webp",F="/assets/case-study-cleanup-CCkUsfBR.webp",W={id:6,title:"Portfolio Iteration: Less Noise, Better Signal",slug:"portfolio-iteration-less-noise-better-signal",date:"2026-01-21",summary:"This update focuses on structural cleanup. I simplified the hero, reduced copy, removed weaker case studies, and updated layouts and visuals so the portfolio reflects how I currently design and build real products.",content:`
    <p class="blog-paragraphs">
    ...
    <img src=${P} alt="Before and after hero section comparison" class="my-6 rounded-lg shadow-lg" />
    ...
    <img src=${$} alt="Updated work section layout" class="my-6 rounded-lg shadow-lg" />
  ...
  This iteration reflects my current level of design judgment. As my work and experience continue to evolve, the portfolio will continue to evolve with it.
    ...
    <img src=${F} alt="Cleaned up case study layout with video and TLDR" class="my-6 rounded-lg shadow-lg" />
  `,tags:["portfolio","ux","product-design"],category:"UX Design",author:{name:"Juan Lagunas",avatar:e,bio:"Product Designer, UX/UI, Front-End",website:"https://juan-lagunas.com"},coverImage:o,thumbnail:o,imageAlt:"Updated portfolio screenshots",readingTime:"3 min read",published:!0,updated:"2026-01-21",relatedPosts:["ux-features-in-my-portfolio"],showToc:!1,problem:"The previous portfolio iteration contained unnecessary friction and did not reflect current structure or priorities.",solution:"Reduced copy, simplified layout, removed weaker work, and clarified navigation and case study structure.",outcome:"A cleaner portfolio that communicates work and context more efficiently."},n="/assets/tlf-blog-mockup-fanc1T9s.webp",L="/assets/portfolio-blog-img-dvcATp9W.webp",E={id:7,title:"The Language Friends: A Real Thing I Built",slug:"the-language-friends-a-real-thing-i-built",date:"2026-01-25",summary:"One week before launch, The Language Friends is finished, live, and doing what it was meant to do. This post is a reflection on building a real product end to end and seeing it come together.",content:`
    <p class="blog-paragraphs">
    ...
    <img src=${L} alt="The Language Friends website and book previews" class="my-6 rounded-lg shadow-lg" />
  ...
  `,tags:["product-design","education","ux","indie"],category:"Product",author:{name:"Juan Lagunas",avatar:e,bio:"Product Designer, UX/UI, Front-End",website:"https://juan-lagunas.com"},coverImage:n,thumbnail:n,imageAlt:"The Language Friends website and book series",readingTime:"4 min read",published:!0,updated:"2026-01-25",relatedPosts:["portfolio-iteration-less-noise-better-signal"],showToc:!1,problem:"Most children’s English materials prioritize explanation and testing over confidence and clarity.",solution:"A simple, constrained system built around repetition, visuals, and real usability.",outcome:"A complete, launch-ready product built end to end."},i="/assets/blog-8-cover-img-CaKrosBv.webp",S={id:8,title:"Why Multilingual UX Is a Real Design Advantage",slug:"why-multilingual-ux-is-a-real-design-advantage",date:"2026-02-03",summary:"Speaking multiple languages is not just a personal detail. It directly shapes how I think about clarity, ambiguity, trust, and cognitive load in UX. This post explains why multilingual and linguistics-informed designers bring a different kind of value to product work.",content:`
  ...
  `,tags:["multilingual-ux","linguistics","international-ux","reflection"],category:"Reflection",author:{name:"Juan Lagunas",avatar:e,bio:"UX Designer with a background in linguistics and international product design",website:"https://yourportfolio.com"},coverImage:i,thumbnail:i,readingTime:"4 min read",published:!0,updated:"2026-02-03",relatedPosts:["living-in-japan-changed-my-ux-thinking","designing-bilingual-interfaces"],showToc:!1},r="/assets/post-9-cover-img-q-D_N70n.webp",M={id:9,title:"Why Customer Service and Teaching Shaped How I Think About UX",slug:"why-customer-service-and-teaching-shaped-how-i-think-about-ux",date:"2026-02-09",summary:"Before I ever learned what UX was, I spent years working directly with people in customer service and teaching. Looking back, those roles shaped how I understand users, clarity, and empathy more than any framework ever could.",content:`
    <p class="blog-paragraphs">Before I ever learned what UX was, I spent years working directly with people. Customer service floors. Classrooms. One-on-one conversations with people who were confused, frustrated, tired, nervous, or just trying to get through their day.</p>

    <p class="mb-2">At the time, I did not think of this as UX training. I thought of it as work. Looking back, it shaped how I understand users more than any framework ever could.</p>

    <h2 class="mt-6 mb-3 text-xl font-semibold">People do not fit clean categories</h2>

    <p class="mb-2">One of the first things customer service teaches you is that people do not fit clean categories. You can group users. You can find patterns. You can build personas. All of that is useful. But the moment you are face to face with real people, those neat categories fall apart.</p>

    <p class="mb-2">Every person who walks up to you is different from the last. Different expectations. Different emotional states. Different levels of patience. Different ways of communicating. In customer service, you do not get the luxury of abstracting that away. You have to read the person in front of you and adapt immediately.</p>

    <h2 class="mt-6 mb-3 text-xl font-semibold">Adapting in real time changes how you see users</h2>

    <p class="mb-2">That adaptation happens fast. You are constantly scanning for cues. Are they rushed or relaxed? Do they want detail or just an answer? Are they frustrated or just confused? You make a decision in seconds about how you will interact with them, because the wrong approach makes the situation worse.</p>

    <p class="mb-2">That experience changed how I think about users. Research can show you patterns, but real interaction forces you to respect individuality. Over time, you learn to balance both. You respect patterns, but you never forget that the person on the other side is not an average.</p>

    <h2 class="mt-6 mb-3 text-xl font-semibold">Teaching showed me communication is multi-channel</h2>

    <p class="mb-2">Teaching reinforced this lesson in a different way. When I taught English, especially at very low levels, I was operating under strict constraints. No Japanese in class. No shortcuts. If a student did not understand me, that was on me.</p>

    <p class="mb-2">Those moments forced me to rethink what communication really is. Language is only one channel. When words fail, you rely on visuals. Gestures. Whiteboards. Movement. Tone. Repetition. Timing. You layer communication until something clicks.</p>

    <p class="mb-2">That experience maps almost perfectly to UX. Interfaces communicate through far more than text. Visual hierarchy, motion, feedback, spacing, sound, and flow all work together to tell the user what is happening and what they can do next. Teaching made me deeply aware that relying on a single channel is rarely enough.</p>

    <h2 class="mt-6 mb-3 text-xl font-semibold">Adjusting complexity based on the person in front of you</h2>

    <p class="mb-2">It also taught me when to simplify and when not to. With beginner students, slowing down and stripping things back was necessary. With advanced students, that same approach became a blocker. They needed pace, nuance, and challenge.</p>

    <p class="mb-2">That adjustment forced me to constantly reassess my assumptions. What does this person actually need right now? What level of complexity is helpful instead of harmful? That question shows up constantly in UX. In onboarding. In feature design. In error states. In progressive disclosure.</p>

    <h2 class="mt-6 mb-3 text-xl font-semibold">Empathy was not a concept, it was practice</h2>

    <p class="mb-2">Customer-facing work also gave me a different relationship with empathy. Empathy was not a concept. It was survival. If you misread someone, you paid for it immediately. A conversation broke down. A situation escalated. A student disengaged.</p>

    <p class="mb-2">Because of that, empathy stopped being something I tried to apply and became something I practiced instinctively. When I later learned UX frameworks, the empathize phase felt familiar. I had already spent years putting myself in someone else’s position under real pressure.</p>

    <h2 class="mt-6 mb-3 text-xl font-semibold">Theory matters, experience gives it weight</h2>

    <p class="mb-2">This is not an argument against theory. Theory matters. Research matters. I am actively deepening that side of my work now. But theory without lived experience stays abstract longer. Experience gives theory weight.</p>

    <p class="mb-2">When you have stood in front of a confused customer, or tried to explain something to someone who does not share your language, you carry that memory into your design decisions. You think differently about clarity. About assumptions. About edge cases. About how easy it is to misunderstand something that feels obvious to you.</p>

    <h2 class="mt-6 mb-3 text-xl font-semibold">How this shows up in my UX work</h2>

    <p class="mb-2">That background is why I design the way I do. I assume misunderstanding is normal. I assume users are coming in with different levels of confidence and context. I assume emotional state matters. My goal is not to design for ideal users, but for real ones.</p>

    <p class="mb-2">I do not think this makes me better than anyone else. It simply means my path trained certain muscles early. Customer service and teaching were not detours from UX. They were my foundation.</p>

    <h2 class="mt-6 mb-3 text-xl font-semibold">Final takeaway</h2>

    <p class="mb-2">This blog exists partly to make that visible. UX is not only what happens in tools or case studies. It is shaped by how you see people. For me, that perspective was built in the trenches, long before I ever put a name to it.</p>

    <p class="mb-2">If there is a takeaway here, it is simple. Strong UX judgment comes from combining theory with lived experience. Patterns with people. Structure with adaptability. That balance is something I will keep refining, both in my work and in how I communicate it.</p>
  `,tags:["ux","reflection","customer-service","teaching","communication","empathy"],category:"Reflection",author:{name:"Juan Lagunas",avatar:e,bio:"UX Designer with a customer-facing and teaching foundation",website:"https://yourportfolio.com"},coverImage:r,thumbnail:r,readingTime:"6 min read",published:!0,updated:"2026-02-09",relatedPosts:[],showToc:!1},J="/assets/language-behance-1-Ca8tJicz.webp",q="/assets/language-behance-2-X0mvvHds.webp",N="/assets/language-behance-3-DxH51gcM.webp",l="/assets/lang-port-img-B58oLOeG.webp",R={id:10,title:"Designing a High-Conversion Landing Page for English Coaching",slug:"designing-a-high-conversion-landing-page-for-english-coaching",date:"2026-04-17",summary:"I built this landing page to stand out by proving my background in linguistics and design through a technical, Brutalist-inspired interface.",content:`
  <p class="blog-paragraphs">I built this site to show my approach to language coaching through a design-heavy lens. I used a technical style to reflect my background in linguistics and product design. Instead of a traditional workflow, I went straight into code with Nuxt 4 and Vanilla CSS, refining the site through eight iterations. This let me test the multilingual states and the timeline logic in the browser. My goal was to create a functional tool that connects me with the students I can help the most.</p>
    <div class="my-8 space-y-4">
      <img src="${J}" alt="Design tokens and project overview" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
      <img src="${q}" alt="Linguistic framework and persistent anchors" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
      <img src="${N}" alt="Proof of execution and strategic intent" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
    </div>
  `,tags:["ux","case-study","linguistics","nuxt","brutalism","i18n"],category:"Case Study",author:{name:"Juan Lagunas",avatar:e,bio:"Product Designer specializing in scalable UX systems",website:"https://jlagunas.com"},coverImage:l,thumbnail:l,readingTime:"3 min read",published:!0,updated:"2026-04-17",relatedPosts:[9],showToc:!1},O="/assets/ux-port-case-1-CfWwzBpQ.webp",H="/assets/ux-port-case-2-tSbuuozJ.webp",Y="/assets/ux-port-case-3-Cj74F_zH.webp",V="/assets/ux-port-case-4-ervRWs7G.webp",d="/assets/post11-cover-img-BDVCr4oM.png",G={id:11,title:"The Meta Case Study: Engineering a Designer Identity",slug:"ux-portfolio-meta-case-study",date:"2026-04-25",summary:"I iterated on this portfolio five times to solve the problem of presenting a professional identity that balances technical engineering with high-impact visual design.",content:`
  <p class="blog-paragraphs">This is my portfolio's most recent iteration. It has been a project that has evolved alongside my skills. I built it to solve a specific problem: how to present myself to employers and designers in a way that is both functional and representative of who I am. It is a feature-rich product that demonstrates my approach to design systems and technical execution. I am proud of features like GSAP-driven hero to the custom blog engine, every part of the site is meant to be a living case study of my process.</p>
    <div class="my-8 space-y-4">
      <img src="${O}" alt="Visual Identity and Brand Equity" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
      <img src="${H}" alt="Hero interaction and information architecture" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
      <img src="${Y}" alt="Technical execution and motion engine" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
      <img src="${V}" alt="Optimization and case study narrative framework" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
    </div>
  `,tags:["ux","product-design","case-study","branding","meta","nuxt"],category:"Case Study",author:{name:"Juan Lagunas",avatar:e,bio:"Product Designer specializing in scalable UX systems",website:"https://juan-lagunas.com"},coverImage:d,thumbnail:d,readingTime:"4 min read",published:!0,updated:"2026-04-25",relatedPosts:[10,5],showToc:!1},Q="/assets/bnb-visual-1-mjXx_sQ2.webp",K="/assets/bnb-visual-2-Cr2UFMnZ.webp",_="/assets/bnb-visual-3-C5fT3I-P.webp",Z="/assets/bnb-visual-4-B9tBX0Uo.webp",ee="/assets/bnb-visual-5-ecoqscuj.webp",c="/assets/bnb-cover-img-D3ZoDq64.webp",te={id:12,title:"A Visual Deep Dive into Bean & Beast",slug:"bean-and-beast-visual-case-study",date:"2026-04-25",summary:"I created a visual case study for Bean & Beast Chocolates to show how storytelling and character lore can transform a standard e-commerce experience into something personal.",content:`
  <p class="blog-paragraphs">I wanted to find a better way to share the story of Bean & Beast. My goal was to create a visual flow that feels as bold and intentional as the chocolate itself. I used this project to practice the full design thinking process from start to finish. I focused on making every feature easy to scan and understand. From the personality quiz to the character lore, these visuals show how I use design and code to build an emotional connection with the user.</p>
    <div class="my-8 space-y-4">
      <img src="${Q}" alt="Bean and Beast Overview and Strategic Intent" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
      <img src="${K}" alt="Research Insights and Visual Packaging Mockups" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
      <img src="${_}" alt="Rapid Ideation and Interactive Flavor Quiz" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
      <img src="${Z}" alt="Character Lore and Modular Engineering Structure" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
      <img src="${ee}" alt="Character Lore and Modular Engineering Structure" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />

    </div>
  `,tags:["ux","product-design","ecommerce","branding","storytelling","vue"],category:"Case Study",author:{name:"Juan Lagunas",avatar:e,bio:"Product Designer specializing in scalable UX systems",website:"https://juan-lagunas.com"},coverImage:c,thumbnail:c,readingTime:"3 min read",published:!0,updated:"2026-04-25",relatedPosts:[11,5],showToc:!1},ae="/assets/denki-study-1-BxNEmy32.webp",se="/assets/denki-study-2-yXnzaPEs.webp",oe="/assets/denki-study-3-BBW5kAG0.webp",ne="/assets/denki-study-4-B-uleho-.webp",ie="/assets/denki-study-5-kpl7GIxU.webp",h="/assets/denki-cover-img-JyvlBMaa.webp",re={id:13,title:"A Visual Deep Dive into Tanaka Denki",slug:"denki-case-study",date:"2026-04-27",summary:"I redesigned the digital presence for a Japanese solar maintenance company to improve B2B trust and simplify content management through a modern, modular architecture.",content:`
  <p class="blog-paragraphs">I partnered with Tanaka Denki to transform an outdated WordPress site into a professional, high-trust platform. My goal was to create a visual experience that speaks to the reliability of industrial infrastructure while navigating the specific expectations of the Japanese market. By combining Nuxt 4 with a headless CMS, I focused on building a system that is easy for the team to manage and even easier for their clients to navigate. These visuals break down the strategy, design system, and technical foundations used to support their business growth.</p>
    <div class="my-8 space-y-4">
      <img src="${ae}" alt="Tanaka Denki Project Overview and Strategic Intent" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
      <img src="${se}" alt="Information Architecture and Navigation Structure" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
      <img src="${oe}" alt="B2B Visual Identity and Trust Signal System" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
      <img src="${ne}" alt="Headless CMS Integration and Content Management" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
      <img src="${ie}" alt="Modular Component Engineering and Performance Outcomes" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
    </div>
  `,tags:["ux","product-design","b2b","nuxt","cms","localization"],category:"Case Study",author:{name:"Juan Lagunas",avatar:e,bio:"Product Designer specializing in scalable UX systems",website:"https://juan-lagunas.com"},coverImage:h,thumbnail:h,readingTime:"3 min read",published:!0,updated:"2026-04-27",relatedPosts:[12,6],showToc:!1},le="/assets/tlf-case-1-YQRWhUTU.webp",de="/assets/tlf-case-2--WrV4a8X.webp",ce="/assets/tlf-case-3-Dyw3l26O.webp",he="/assets/tlf-case-4-CVGVOp-b.webp",ue="/assets/tlf-case-5-DBzMJDYt.webp",ge="/assets/tlf-case-6-CLU8J3n4.webp",u="/assets/tlf-cover-img-BrOlFmSt.webp",me={id:14,title:"A Visual Deep Dive into The Language Friends",slug:"tlf-case-study",date:"2026-04-27",summary:"I designed and built a bilingual English-learning ecosystem for children in Japan, focusing on confidence-first pedagogy, character-driven UX, and scalable modular architecture.",content:`
  <p class="blog-paragraphs">The Language Friends was born from a desire to rethink how young children in Japan experience English. My goal was to move away from the high-pressure, grammar-heavy norm and create a system grounded in emotional safety and natural pattern recognition. In 45 days, I designed and produced five original books and a bilingual Nuxt 4 website, iterating directly in code to master the complexities of multilingual typography. These visuals showcase the transition from a real-world observation to a launch-ready product ecosystem where every interaction is designed to build confidence.</p>
    <div class="my-8 space-y-4">
      <img src="${le}" alt="The Language Friends Overview and Strategic Intent" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
      <img src="${de}" alt="Pedagogical Framework and Pattern Recognition Foundations" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
      <img src="${ce}" alt="Character System and Emotional UX Anchors" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
      <img src="${he}" alt="Bilingual Typography and Designing in Code Methodology" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
      <img src="${ue}" alt="Bento-Style UI and Trust-First Landing Experience" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
      <img src="${ge}" alt="Modular Architecture and Scalable i18n System" class="w-full rounded-sm border border-gray-200 dark:border-gray-800" />
    </div>
  `,tags:["ux","product-design","edtech","multilingual-ux","bilingual","nuxt"],category:"Case Study",author:{name:"Juan Lagunas",avatar:e,bio:"Product Designer specializing in scalable UX systems",website:"https://juan-lagunas.com"},coverImage:u,thumbnail:u,readingTime:"4 min read",published:!0,updated:"2026-04-27",relatedPosts:[13,12],showToc:!1},g="/assets/post-15-cover-img-DoJ0ahhc.png",pe={id:15,title:"Building a Daily Content Engine as a Product Designer",slug:"building-a-daily-content-engine-as-a-product-designer",date:"2026-09-03",summary:"When I decided to launch my Japanese learning YouTube channel, I approached it through the lens of product design: identifying real friction points, building modular systems, and creating a sustainable daily production pipeline.",content:`
  ...
  `,tags:["ux","product-design","systems-thinking","workflow","language-learning","youtube"],category:"Case Study",author:{name:"Juan Lagunas",avatar:e,bio:"Product and UX Designer focused on systems, clarity, and execution",website:"https://yourportfolio.com"},coverImage:g,thumbnail:g,readingTime:"5 min read",published:!0,updated:"2026-09-03",relatedPosts:[],showToc:!1},fe=f("blog",{state:()=>({posts:[pe,me,re,te,G,R,M,S,E,W,z,D,T,x,v]}),getters:{getPostBySlug:m=>p=>m.posts.find(b=>b.slug===p)}});export{fe as u};
