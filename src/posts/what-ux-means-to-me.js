...
export default {
  id: 1,
  title: 'What UX Means to Me',
  slug: 'what-ux-means-to-me',
  date: '2025-08-05',

  summary:
    'UX didn’t just become the career I had always been after. It became a mirror of how I live, think, and grow. But what does that really mean? Read about how I realized UX was always part of my life long before I had ever heard the term "UX".',
  content: `
  ...
  tags: ['personal', 'career', 'ux-philosophy'],
  category: 'Reflection',
  ...
  coverImage: uxImg2,
  thumbnail: uxImg,
  imageAlt: 'Abstract visual representing UX journey',

  readingTime: '6 min read',
  published: true,
  updated: '2025-08-05',

  relatedPosts: ['why-i-chose-vue', 'ux-vs-ui'],
  showToc: false,

  problem:
    'I felt disconnected from my work and wanted to find a field that aligned with my natural way of thinking and growing.',
  solution:
    'UX gave me a framework that mirrored how I already approach challenges in life. Empathetically, iteratively, and with intention.',
  outcome:
    'I’ve found a career path that excites me, challenges me, and gives me space to evolve. And I’m all in.',
}
